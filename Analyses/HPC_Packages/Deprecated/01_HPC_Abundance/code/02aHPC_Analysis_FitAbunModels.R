...
threshold_mod_summary <- readRDS('data/abundance_mod_summary.rds') # this might cause problems in. parallel environemnt
...
saveRDS(threshold_mod_summary, paste0('results/ABUGAM_RDS/', covariate ,"/", modname,'_mod_summary.rds'))
